      ...
      <div className="owner-grid">
        ...
        <div className="owner-info">
          ...
          <div className="owner-bio">
            <p>With years of experience in animal husbandry and Information Technology, Ayojesu Ajayi started G-Jotar Acres Farm with a vision to provide Nigeria with premium, ethically-raised livestock. A graduate of Computer Science from Ladioke Akintola University of Technology, Ogbomosho with a Master Degree in Cyber Security at Tesside University, United Kingdom. He has trained over 500 small-scale farmers across West Africa.</p>
